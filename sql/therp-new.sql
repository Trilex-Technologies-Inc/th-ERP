...
-- Retail POS extensions. Keep this section synchronized with pos_retail_upgrade.sql.
CREATE TABLE IF NOT EXISTS pos_payment_method (
  methodid varchar(20) NOT NULL, description varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS pos_shift (
  shiftid int unsigned NOT NULL AUTO_INCREMENT, username varchar(16) NOT NULL,
  locationid int unsigned NOT NULL, opened_at datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS pos_store_credit (
  ...
  reference varchar(80) DEFAULT NULL, expires_at datetime DEFAULT NULL,
  createdby varchar(16) DEFAULT NULL, createdtime datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (creditid)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS pos_return (
  returnid int unsigned NOT NULL AUTO_INCREMENT, orderid int unsigned NOT NULL,
  reason varchar(255) NOT NULL, refund_method varchar(20) NOT NULL,
  total decimal(12,2) NOT NULL DEFAULT 0, createdby varchar(16) DEFAULT NULL,
  createdtime datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (returnid),
  KEY pos_return_order (orderid)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS pos_return_item (
  returnid int unsigned NOT NULL, order_line smallint unsigned NOT NULL,
  productid varchar(32) NOT NULL, quantity decimal(12,3) NOT NULL,
  amount decimal(12,2) NOT NULL, PRIMARY KEY (returnid, order_line),
