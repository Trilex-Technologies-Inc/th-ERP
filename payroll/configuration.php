...
<div class="payroll-settings-card payroll-settings-card-disabled" aria-disabled="true"><span class="payroll-settings-card-icon payroll-settings-card-icon-purple"><svg viewBox="0 0 24 24"><path d="M4 18V6"/><path d="M20 18V6"/><path d="M8 12h8"/><path d="m13 9 3 3-3 3"/><path d="m11 9-3 3 3 3"/></svg></span><span class="payroll-settings-card-copy"><strong><?php etr("Range sets") ?></strong><small><?php etr("Coming soon: maintain thresholds and stepped ranges.") ?></small></span><span class="payroll-settings-card-status"><?php etr("Coming soon") ?></span></div>
